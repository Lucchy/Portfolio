  ...
  return (
    <div className='app'>
      ...
      <Header icon = 'rocket_launch' title="Lucas.couchy"/>
        ...
        <About>
          Fascinated by technology, my initial focus on mechatronics led me into the captivating world of web development. While working on a human-machine interface during my professional degree, I was fascinated by the process of coding applications.<br/>
